...
$your_email = "blommansforskola@hotmail.com"; // email address to which the form data will be sent
$subject = "Meddelande"; // subject of the email that is sent
$thanks_page = "tack.html"; // path to the thank you page following successful form submission
$contact_page = "kontakt.html"; // path to the HTML contact page where the form appears
